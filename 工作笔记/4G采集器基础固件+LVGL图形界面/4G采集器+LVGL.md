...
5. MBUS 乱码问题 -> 第四版中有一块板子的在测试固件中会出现乱码现象。
   ...
   ![image-20230927112651941](https://dearliao.oss-cn-shenzhen.aliyuncs.com/Note/picture/202310081058350.png)
   ...
   3. 注释 uart.write(1,"uart1 sendMSG!") 之后依旧有2行乱码字符。
      ...
      ![image-20230927113055849](https://dearliao.oss-cn-shenzhen.aliyuncs.com/Note/picture/202310081058351.png)
